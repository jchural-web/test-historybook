...
export class CrmPageComponent {
  ...
  navigationTabs = [
    { label: 'Contacto Entrante', count: 1, color: 'blue' as const, variant: 'solid' as const, isActive: true },
    { label: 'Prog. Automaticas', count: 0, color: 'gray' as const, variant: 'soft' as const, isActive: false },
    { label: 'Prog. Manuales', count: 5, color: 'blue' as const, variant: 'soft' as const, isActive: false },
    { label: 'No Prog. 1 Solicitud', count: 0, color: 'gray' as const, variant: 'soft' as const, isActive: false },
    { label: 'No Prog. +1 Solicitudes', count: 0, color: 'gray' as const, variant: 'soft' as const, isActive: false },
    { label: 'Altas y Medias', count: 9, color: 'blue' as const, variant: 'soft' as const, isActive: false },
    { label: 'Vencidas [IP, IC, PF]', count: 9, color: 'green' as const, variant: 'soft' as const, isActive: false },
    { label: 'Vencidas [IS, M]', count: 9, color: 'green' as const, variant: 'soft' as const, isActive: false },
    { label: 'Realizadas', count: 0, color: 'gray' as const, variant: 'soft' as const, isActive: false },
    { label: 'Pre-Lanzamiento', count: 6, color: 'orange' as const, variant: 'soft' as const, isActive: false },
    ...
    { label: 'Venta Cruzada', count: 0, color: 'gray' as const, variant: 'soft' as const, isActive: false },
  ];
