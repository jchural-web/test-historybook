...
@Component({
  ...
  template: `
    <div class="carousel-container">
      <!-- Main carousel with arrows and viewport -->
      <div class="carousel-root">
        <!-- Previous Button (positioned absolutely outside viewport) -->
        <button
          *ngIf="showArrows"
        ...
        <!-- Next Button (positioned absolutely outside viewport) -->
        <button
          *ngIf="showArrows"
      ...
      <!-- Indicators (inside container, below carousel-root) -->
