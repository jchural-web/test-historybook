...
/**
 * Avatar sizes: xs, sm, md, lg, and xl.
 * Demonstrates all available sizes with consistent fallback content.
 */
...
/**
 * Avatar content/state types: default (icon/image), and fallback (initials).
 * Shows how the avatar displays different content based on the type prop.
 */
  ...
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <div>
          <h4 style="margin: 0 0 16px 0; font-size: 14px; font-weight: 600; color: #202020;">Default State (Icon)</h4>
          <div style="display: flex; align-items: center; gap: 16px;">
            <div style="text-align: center;">
              <bsg-avatar size="sm" type="default" image=""></bsg-avatar>
              <div style="font-size: 12px; color: #64748B; margin-top: 8px;">No Image</div>
            </div>
          </div>
        </div>

        <div>
          <h4 style="margin: 0 0 16px 0; font-size: 14px; font-weight: 600; color: #202020;">Default State (Image)</h4>
          <div style="display: flex; align-items: center; gap: 16px;">
            <div style="text-align: center;">
              <bsg-avatar 
                size="sm" 
              ...
              <div style="font-size: 12px; color: #64748B; margin-top: 8px;">With Image</div>
            </div>
          </div>
        </div>

        <div>
          <h4 style="margin: 0 0 16px 0; font-size: 14px; font-weight: 600; color: #202020;">Fallback State (Initials)</h4>
          <div style="display: flex; align-items: center; gap: 16px;">
            <div style="text-align: center;">
              <bsg-avatar size="sm" type="fallback" initials="JC"></bsg-avatar>
              <div style="font-size: 12px; color: #64748B; margin-top: 8px;">JC Initials</div>
            </div>
          </div>
        </div>
      </div>
...
/**
 * Common usage patterns and real-world examples of the Avatar component.
 */
...
/**
 * Interactive playground for testing all avatar configurations.
 * Use the controls to experiment with different sizes, types, and content.
 */
...
/**
 * Complete design system showcase featuring all avatar sizes, types,
 * and design specifications for reference and documentation.
 */
        ...
        <section style="margin-top: 64px;">
          ...
          <div style="font-size: 14px; color: #64748B; line-height: 1.8;">
            ...
            <ul style="margin: 8px 0 8px 20px;">
              ...
              <li>Icon Color: Primary token color</li>
            ...
            <ul style="margin: 8px 0 8px 20px;">
              <li>Background: Primary token color</li>
