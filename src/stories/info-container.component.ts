            ...
            <div class="info-container-table-body">
              <div
                *ngFor="let row of tableRows; let i = index"
                class="info-container-table-row"
              >
                <div
                  *ngFor="let column of tableColumns"
