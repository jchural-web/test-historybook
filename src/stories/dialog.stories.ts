    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 32px;">
        ...
        <div>
          ...
          <bsg-dialog [open]="true" size="md" headerTone="brand" [dismissible]="false" [hasFooter]="false">
        ...
        <div>
          ...
          <bsg-dialog [open]="true" size="md" headerTone="brand" [dismissible]="false" [hasFooter]="true">
            ...
            <div dialog-footer>
              <bsg-button variant="outline" size="md" label="Cancelar"></bsg-button>
              <bsg-button variant="default" size="md" label="Aceptar"></bsg-button>
            </div>
          </bsg-dialog>
        </div>
      </div>
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 32px;">
        ...
        <div>
          ...
          <bsg-dialog [open]="true" size="sm" headerTone="brand" [dismissible]="true">
            ...
            <div dialog-footer>
              <bsg-button variant="destructive" size="md" label="Cerrar"></bsg-button>
            </div>
          </bsg-dialog>
        </div>
        ...
        <div>
          ...
          <bsg-dialog [open]="true" size="md" headerTone="info" [scrollable]="true" [dismissible]="true">
      ...
      <div style="display: flex; flex-direction: column; gap: 32px;">
        ...
        <div>
          ...
          <bsg-dialog [open]="true" size="sm" headerTone="brand" [dismissible]="true">
            ...
            <div dialog-footer>
              <bsg-button variant="destructive" size="md" label="Cancelar"></bsg-button>
        ...
        <div>
          ...
          <bsg-dialog [open]="true" size="md" headerTone="brand" [dismissible]="true" [scrollable]="false">
            ...
            <div dialog-footer>
              <bsg-button variant="outline" size="md" label="Cancelar"></bsg-button>
              <bsg-button variant="default" size="md" label="Guardar"></bsg-button>
            </div>
          </bsg-dialog>
        </div>

        <!-- Detail View Example (like Figma design 3) -->
        <div>
          <h4 style="margin: 0 0 12px 0; font-size: 14px; font-weight: 600; color: #202020;">Vista de Detalle Compleja</h4>
          <bsg-dialog [open]="true" size="lg" headerTone="secondary" [dismissible]="true" [scrollable]="true">
            <div dialog-header>
