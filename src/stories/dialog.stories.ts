        ...
        <bsg-dialog [open]="openDetail" size="lg" headerTone="secondary" [dismissible]="true" [scrollable]="true" (closeDialog)="openDetail = false">
          ...
          <div dialog-body style="padding: 0;">
            ...
            <div style="display: flex; align-items: center; gap: 8px; padding: 20px 20px 0 20px;">
              <div style="padding: 11px 14px; background: #9333EA; color: #FFF; border-radius: 8px; font-size: 14px; font-weight: 500;">Resumen</div>
              <div style="padding: 11px 14px; background: #FAF5FF; color: #9333EA; border-radius: 8px; font-size: 14px; font-weight: 500;">Detalles</div>
              <div style="padding: 11px 14px; background: #FAF5FF; color: #9333EA; border-radius: 8px; font-size: 14px; font-weight: 500;">Histórico</div>
              <div style="padding: 11px 14px; background: #FAF5FF; color: #9333EA; border-radius: 8px; font-size: 14px; font-weight: 500;">Datos Personales</div>
            </div>

            <!-- Resumen Crediticio Section -->
            <div style="margin: 20px; padding: 18px; border: 1px solid #CBD5E1; border-radius: 12px; background: #FFF;">
              <div style="padding: 20px 17px; background: #F3E8FF; border-radius: 12px 12px 0 0; margin: -18px -18px 0 -18px;">
                <div style="font-size: 16px; font-weight: 600; color: #7C3AED;">Resumen Crediticio</div>
              </div>
              <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-top: 20px;">
                <div style="padding: 24px; background: #F1F5F9; border: 1px solid #F1F5F9; border-radius: 8px;">
                  <div style="font-size: 14px; font-weight: 500; color: #1E293B; margin-bottom: 16px;">Calificación Actual</div>
                  <div style="font-size: 24px; font-weight: 500; color: #16A34A;">Normal</div>
                </div>
                <div style="padding: 24px; background: #F1F5F9; border: 1px solid #F1F5F9; border-radius: 8px;">
                  <div style="font-size: 14px; font-weight: 500; color: #1E293B; margin-bottom: 16px;">Deuda Total</div>
                  <div style="font-size: 24px; font-weight: 500; color: #16A34A;">S/. 3609.21</div>
                  <div style="font-size: 12px; font-weight: 500; color: #64748B; margin-top: 8px;">Actualizado al 24/03/2025</div>
                </div>
                <div style="padding: 24px; background: #F1F5F9; border: 1px solid #F1F5F9; border-radius: 8px;">
                  <div style="font-size: 14px; font-weight: 500; color: #1E293B; margin-bottom: 16px;">Entidades Financieras</div>
                  <div style="font-size: 24px; font-weight: 500; color: #9333EA;">2</div>
                  <div style="font-size: 12px; font-weight: 500; color: #64748B; margin-top: 8px;">Con deuda reportada</div>
                </div>
              </div>
            </div>
            ...
            <div style="margin: 20px; padding: 18px; border: 1px solid #CBD5E1; border-radius: 12px; background: #FFF;">
              <div style="padding: 20px 17px; background: #F3E8FF; border-radius: 12px 12px 0 0; margin: -18px -18px 0 -18px;">
                <div style="font-size: 16px; font-weight: 600; color: #7C3AED;">Semáforo de los últimos 4 meses</div>
              </div>
              <div style="margin-top: 24px; text-align: center;">
                <div style="display: flex; justify-content: center; gap: 24px; margin-bottom: 16px;">
                  <svg width="569" height="17" viewBox="0 0 569 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div style="display: flex; justify-content: center; gap: 16px; flex-wrap: wrap;">
                  ...
                  <div style="display: flex; align-items: center; gap: 4px;">
                    ...
                    <span style="font-size: 14px; font-weight: 500; color: #1E293B;">Deficiente</span>
                  </div>
                  <div style="display: flex; align-items: center; gap: 4px;">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="6" cy="6" r="6" fill="#94A3B8"/>
                    </svg>
                    <span style="font-size: 14px; font-weight: 500; color: #1E293B;">Sin información</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style="margin: 20px; padding: 18px; border: 1px solid #CBD5E1; border-radius: 12px; background: #FFF;">
              <div style="padding: 20px 17px; background: #F3E8FF; border-radius: 12px 12px 0 0; margin: -18px -18px 0 -18px;">
                <div style="font-size: 16px; font-weight: 600; color: #7C3AED;">Detalle de la deuda SBS/Microfinanzas</div>
              </div>
              <div style="margin-top: 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                  <thead>
                    <tr style="border-bottom: 1px solid #CBD5E1;">
                      <th style="padding: 12px 18px; text-align: left; font-size: 14px; font-weight: 500; color: #334155;">Entidad</th>
                      <th style="padding: 12px 18px; text-align: left; font-size: 14px; font-weight: 500; color: #334155;">Calificación</th>
                      <th style="padding: 12px 18px; text-align: left; font-size: 14px; font-weight: 500; color: #334155;">Monto</th>
                      <th style="padding: 12px 18px; text-align: left; font-size: 14px; font-weight: 500; color: #334155;">Días Vencidos</th>
                      <th style="padding: 12px 18px; text-align: left; font-size: 14px; font-weight: 500; color: #334155;">Fecha Reporte</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr style="border-bottom: 1px solid #CBD5E1;">
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">BCP</td>
                      <td style="padding: 16px 18px;">
                        <span style="display: inline-flex; padding: 10px 15px; background: #F0FDF4; color: #16A34A; border-radius: 9999px; font-size: 10px; font-weight: 600;">NOR</span>
                      </td>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">S/ 2601.21</td>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">0</td>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">28/02/2025</td>
                    </tr>
                    <tr>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">BCO FALABELLA PERÚ</td>
                      <td style="padding: 16px 18px;">
                        <span style="display: inline-flex; padding: 10px 15px; background: #F0FDF4; color: #16A34A; border-radius: 9999px; font-size: 10px; font-weight: 600;">NOR</span>
                      </td>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">S/ 1000</td>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">0</td>
                      <td style="padding: 16px 18px; font-size: 14px; font-weight: 500; color: #334155;">28/02/2025</td>
                    </tr>
                  </tbody>
            ...
            <div style="margin: 20px; padding: 18px; border: 1px solid #CBD5E1; border-radius: 12px; background: #FFF;">
              <div style="padding: 20px 17px; background: #F3E8FF; border-radius: 12px 12px 0 0; margin: -18px -18px 0 -18px;">
                <div style="font-size: 16px; font-weight: 600; color: #7C3AED;">Documento de Identidad Consultado</div>
              </div>
