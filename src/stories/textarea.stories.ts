...
export const InForm: Story = {
  render: () => ({
    template: `
      <div style="font-family: Roboto, sans-serif; padding: 24px; max-width: 400px;">
        <h3 style="margin-bottom: 16px; font-size: 18px; font-weight: 600;">Contact Form</h3>
        <form style="display: flex; flex-direction: column; gap: 16px;">
          <div style="display: flex; flex-direction: column; gap: 8px;">
            <label style="font-size: 14px; font-weight: 500; color: #202020;">
              Mensaje *
            </label>
            <storybook-textarea 
              state="default"
          ...
          <div style="display: flex; flex-direction: column; gap: 8px;">
            <label style="font-size: 14px; font-weight: 500; color: #DC2626;">
              Error example
            </label>
            <storybook-textarea 
              state="error"
            ...
            ></storybook-textarea>
            <span style="font-size: 12px; color: #DC2626;">Este campo es requerido</span>
          </div>
        </form>
      </div>
    `,
